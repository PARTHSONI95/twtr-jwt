...
const SignIn = () => {
  ...
  function handleSubmit(event) {
    ...
    fetch(`http://flask-react-alb-270289548.us-east-1.elb.amazonaws.com/login`, config)
  ...
  function handleFastSignIn() {
   ...
   // print("Signin.js: fetching from " + `${process.env.REACT_APP_API_SERVICE_URL}/fastlogin`)
    ...
    fetch(`http://flask-react-alb-270289548.us-east-1.elb.amazonaws.com/fastlogin`, config)
      .then(response => response.json())
      .then(data => {
